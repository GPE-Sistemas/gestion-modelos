...
export const IDeviceProfileDetailChirpstackDTOValidation =
  joi.object<IDeviceProfileDetailChirpstackDTO>({
...
export const IDeviceProfileDetailChirpstackDTOSwagger = j2s(
  IDeviceProfileDetailChirpstackDTOValidation
).swagger;
